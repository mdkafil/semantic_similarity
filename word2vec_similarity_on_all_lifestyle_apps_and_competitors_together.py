...
if __name__ == '__main__':
    ...
    wordmodelfile="./Downloads/wiki.en.vec"
    ...
    with open('..\\Dataset\\GooglePlay2020\\Communication\\comm_top_free\\app_desc_competitors.csv', encoding='utf-8',errors='ignore') as f_a:
        ...
        for line_a in f_csv_a:
            ...
            if count==1:
                break
            count=count+1
            with open('..\\GooglePlay2020\\Communication\\comm_top_free\\app_desc2.csv', encoding='utf-8',errors='ignore') as f_b:
